$(document).ready(function()
{
    ...
    //change rights settings on file ressource
    $("form[id^='ressource-rights']").on("change", function(e){
        var targetID = $(this).attr("data-ressources-rights-id");
        var jQForm = $(this);
        updateFile('updaterights', targetID, jQForm);
    });
...
function updateFile(action, id , jqEl){
	...
	if (action == 'add'){
		...
		form_data.append('access_rights', $('#ressources-addpermission').val());
    ...
    else if(action == 'updaterights'){
        var formData = jqEl.serializeArray();
        //get all form input checkbox values  
        var data =[];
        ...
        form_data.append('id', id);
        form_data.append('accessrights', JSON.stringify( data ) );
    }
	else
	{
		...
		success:function(data, textStatus, jqXHR)
				{
					...
					else if(action == 'delete')
					{
                        ...
                        console.log('rights update complete');
                    }
