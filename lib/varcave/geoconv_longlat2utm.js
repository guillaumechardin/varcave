...
function getCoordEditBoxes_UTM(geoCoords){
    ...
    converted.forEach( function(item){
        ...
        html += '   ZONE:<input type="text" class="coords" data-elNumber="0" value="' + item.zone + '" />';
        html += '   X:<input type="text" class="coords" data-elNumber="1" value="' + item.x + '" />';
        html += '   Y:<input type="text" class="coords" data-elNumber="2" value="' + item.y + '" />';
        html += '   Z:<input type="text" class="coords" data-elNumber="3" value="' + item.z + '" />';
...
function UTM_2longlat(coordSetIdx){
    ...
    var utmZoneFull = $('.editCoords[data-coordSet="'+coordSetIdx+'"] > .coords[data-elNumber="0"' ).val();
    var utmZone = parseInt(utmZoneFull, 10);
    var utmBand = utmZoneFull();
    
    var x = $('.editCoords[data-coordSet="'+coordSetIdx+'"] > .coords[data-elNumber="1"' ).val();
    var y = $('.editCoords[data-coordSet="'+coordSetIdx+'"] > .coords[data-elNumber="2"' ).val();
    var z = $('.editCoords[data-coordSet="'+coordSetIdx+'"] > .coords[data-elNumber="3"' ).val();
    console.log(utmZone);
    return false;
