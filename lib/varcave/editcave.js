...
{
	$("input[type='text'], textarea, input[type='checkbox'], select").not('#quickSearchInput, .coords, .edit-filenote, .changeloginput, .file-upload-selector').on("change", function() 
	{
		...
		success: function(data, textStatus, jqXHR)
				{
                    ...
                    if(data.actionType == 'add')
                    {
                        ...
                        html += '   long:<input type="text" class="coords" data-coord="long"  value="' + values.long +  '" />';
                        html += '   lat:<input type="text" class="coords" data-coord="lat" value="' + values.lat +  '" />';
                    ...
                    if(data.actionType == 'edit'){
                        ...
                        coordList.features.forEach( function(item,i) {
                            ...
                            if( item.properties.id == coordSetIdx ){ 
                                ...
                                coordList.features[i].geometry.coordinates = [ parseFloat(values.long), parseFloat(values.lat), parseFloat(values.z) ];
                            }else{
                                console.log('not found in array');
                            }
                        }, longitude, latitude);
