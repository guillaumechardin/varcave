		...
		success: function(data, textStatus, jqXHR)
				{
                    ...
                    if(data.actionType == 'add')
                    {
                        ...
                        newHtml += '   Y:<input type="text" class="coords" data-elNumber="1" value="1" />';
                        newHtml += '   Z:<input type="text" class="coords" data-elNumber="2" value="1" />';
                        newHtml += '  &nbsp<span class="fas fa-trash-alt fa-lg"  id="edit-delCoordSet" ></span>';
                        console.log(coordinatesList);
                        (coordinatesList.features[0].geometry.coordinates).push( [2,2,2] );
                        console.log(coordinatesList);
                        newHtml += '</div>';
