    ...
    coordsObj.forEach(function(coord) {
        ...
        convertedData.push(
            {   
                ...
                string : 'long' + coord.geometry.coordinates[0] + ' lat' + coord.geometry.coordinates[1] + ' Alt:' + Z,
            });
    });
...
function getCoordEditBoxes_GEOGRAPHIC(coordsList) {
    ...
    list.forEach( function(item){
        ...
        newHtml +=  '   long<input type="text" class="coords" data-coord="longlat"  value="' +   item.geometry.coordinates[0] + '" />';
        newHtml +=  '   lat<input type="text" class="coords" data-coord="lat" value="' +   item.geometry.coordinates[1]  + '" />';
