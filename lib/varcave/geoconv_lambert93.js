 ...
 */
function convert2LAMBERT93(coordsJsonObj)
{
    //extract only usefull data from object
    console.log('Started long/lat to LAMBERT93 conversion');
    ...
    coordsObj.forEach(function(coord) {
        ...
        var dest = ('+proj=lcc +lat_0=46.5 +lon_0=3 +lat_1=49 +lat_2=44 +x_0=700000 +y_0=6600000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs +type=crs');
 ...
 */
function getCoordEditBoxes_LAMBERT93(geoCoords){
    console.log('build new input boxes for lambert3')
    var converted = convert2LAMBERT93(geoCoords);
    var html = '';
 ...
 */
function LAMBERT93_2longlat(coordSetIdx){
    console.log('convert Lambert93 to geographic coordinates');
    ...
    var source = ('+proj=lcc +lat_0=46.5 +lon_0=3 +lat_1=49 +lat_2=44 +x_0=700000 +y_0=6600000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs +type=crs');
    var dest = ('+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs');
    
    var converted = proj4(source,dest, srcCoords);
    console.log( 'Converted Lambert93 => X:'+converted.x + ' Y:' +converted.y );
